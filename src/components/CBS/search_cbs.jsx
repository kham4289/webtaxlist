    ...
    const OponPDF = async () => {
      try {
        const response = await fetch(
          `http://172.28.14.225:2024/tplus-service/update-pdf/BILL_202404/202404_HOT_BILL/202404_${phone.CustomerID}.pdf`,
          {
            method: "GET",
            headers: {
        ...
        <div>
          {fileUrl ? (
            <iframe
              ...
              width="100%"
              height="600px"
              src={`http://172.28.14.225:2024/tplus-service/update-pdf/BILL_202404/202404_HOT_BILL/202404_${phone.CustomerID}.pdf`}
            />
          ) : (
            <div
              style={{
